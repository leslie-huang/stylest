...
#' rownames and for each document, either its the most likely author 
#' or the probability that it was written by each possible author.
#' 
...
#' using a logistic transformation across rows, a.k.a. 'softmax'.
#' 
...
#' @param newdata A character vector of texts or a \code{\link{corpus_frame}}
#' @param type Type of prediction "\code{predicted}" (the default),
